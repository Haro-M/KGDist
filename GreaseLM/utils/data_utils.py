...
class GreaseLM_DataLoader(object):
    ...
    def __init__(self, train_statement_path, train_adj_path,
        ...
        *self.train_decoder_data, self.train_adj_data = self.load_sparse_adj_data_with_contextnode(train_adj_path, max_node_num, train_concepts_by_sents_list)
        ...
        # Load dev data
        self.dev_qids, self.dev_labels, self.dev_encoder_data, dev_concepts_by_sents_list = self.load_input_tensors("/home/lpz/MHL/KG_Distillation/GreaseLM/data/distill_obqa/statement/distill.statement.jsonl", max_seq_length)
        *self.dev_decoder_data, self.dev_adj_data = self.load_sparse_adj_data_with_contextnode("/home/lpz/MHL/KG_Distillation/GreaseLM/data/distill_obqa/graph/distill.graph.adj.pk", max_node_num, dev_concepts_by_sents_list)
