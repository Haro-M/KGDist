...
def load_candidate_maps(fname, topk=30, count_smoothing=1):
    ...
    with JsonFile("/home/lpz/mhl/KG_Distill/kb/checkpoint/entities.jsonl", 'r') as fin:
        for entity in fin:
...
class WordNetFineGrainedSenseDisambiguationReader(EntityLinkingReader):
    ...
    def _read(self, file_path: str):
        with JsonFile(file_path, 'r') as fin:
            for sentence in fin:
    ...
    def text_to_instance(self,
        ...
        return Instance(fields)#, should_remap_span_indices=False)
...
class WordNetAllEmbedding(torch.nn.Module, EntityEmbedder):
    ...
    def __init__(self,
        ...
        if pos_embedding_dim is not None:
            ...
            # list of entity ids
            entities = ['@@PADDING@@']
            with open("/home/lpz/mhl/KG_Distill/kb/checkpoint/wordnet_synsets_mask_null_vocab.txt", 'r') as fin:
                for line in fin:
        ...
        # load the embeddings
        with h5py.File("/home/lpz/mhl/KG_Distill/kb/checkpoint/wordnet_synsets_mask_null_vocab_embeddings_tucker_gensen.hdf5", 'r') as fin:
        ...
        if include_null_embedding:
            ...
            with open("/home/lpz/mhl/KG_Distill/kb/checkpoint/wordnet_synsets_mask_null_vocab.txt", 'r') as fin:
                for line in fin:
                    entities.append(line.strip())
            self.null_id = 15221#entities.index("@@NULL@@")
