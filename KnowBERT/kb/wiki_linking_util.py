...
class WikiCandidateMentionGenerator(MentionGenerator):
    ...
    def __init__(self,
        ...
        if isinstance(entity_world_path, dict):
            ...
            entity_world_path = "/home/lpz/mhl/KG_Distill/kb/checkpoint/wiki_id_to_string.json"
        ...
        if pickle_cache_file is not None:
            ...
            candidates_file = "/home/lpz/mhl/KG_Distill/kb/checkpoint/prob_yago_crosswikis_wikipedia_p_e_m.txt"
